...
private:
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
    {
        ...
        vUserData = clsString::SplitByDelimiter(Line, Seperator);
    ...
    static stLoginRegisterRecord _ConvertLineToUserRegisterRecord(string RegisterRecordLine)
    {
        vector<string> vString = clsString::SplitByDelimiter(RegisterRecordLine, "#//#");
...
public:
    ...
    bool CheckAccressPermission(enPermissions Permissions)
    {
    ...
    void RegisterLogIn()
    {
        ...
        fstream MyFile;
        MyFile.open("LoginResister.txt", ios::out | ios::app);
    ...
    static vector<stLoginRegisterRecord> LoadLoginRegisterUsers()
    {
        vector<stLoginRegisterRecord> vLoginUsers;

        fstream MyFile;
        MyFile.open("LoginResister.txt", ios::in);
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                if (!Line.empty())
                {
                    LoginRegisterRecord = _ConvertLineToUserRegisterRecord(Line);
